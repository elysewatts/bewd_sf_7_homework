...
class ShirtsControllerTest < ActionController::TestCase
  ...
  test "should create shirt" do
    assert_difference('Shirt.count') do
      post :create, shirt: { color: @shirt.color, index: @shirt.index, name: @shirt.name, show: @shirt.show }
    end
  ...
  test "should update shirt" do
    patch :update, id: @shirt, shirt: { color: @shirt.color, index: @shirt.index, name: @shirt.name, show: @shirt.show }
    assert_redirected_to shirt_path(assigns(:shirt))
  end
