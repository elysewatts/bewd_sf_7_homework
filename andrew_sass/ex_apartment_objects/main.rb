...
## Note for TAs - I'm unsure why my program seems to 'break' after the question about whether or not the apartment is rented. Regardless of whether the user types y or n, nothing seems to happen. Any suggestions would be appreciated!
...
apt_count = gets.to_i
 ...
 0.upto(apt_count - 1) do |unit|
  ...
  puts "Is unit #{apartment.name} rented? Type y for yes or n for no."
  unit_rented = gets.strip
  unit_available = gets.strip
